...
#touch counter.txt
#echo 0 > /home/tegwyn/ultrasonic_classifier/helpers/counter.txt
...
if [ -f "$FILE" ]; then
  bat_detected=1
  cd /home/tegwyn/ultrasonic_classifier/temp/
  cp new_${iter}.wav /home/tegwyn/ultrasonic_classifier/detected_bat_audio/
...
if [ -f "$FILE" ]; then
  ...
  cp ${newName2}.wav /home/tegwyn/ultrasonic_classifier/detected_bat_audio/
...
# aplay /home/tegwyn/ultrasonic_classifier/alert_sounds/keys.wav
# aplay --device=hw:0,0 keys.wav

# cd /home/tegwyn/ultrasonic_classifier/alert_sounds/
# aplay --device=hw:0,0 /home/tegwyn/ultrasonic_classifier/alert_sounds/keys.wav       # Currently sets to HDMI for testing.
